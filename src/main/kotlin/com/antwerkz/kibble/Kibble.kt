...
//    })
    ...
    fun createResolutionFacade(environment: KotlinCoreEnvironment): KibbleResolutionFacade {
...
class ResolveElementCache(
    ...
    private val fullResolveCache: CachedValue<MutableMap<KtElement, CachedFullResolve>> = CachedValuesManager.getManager(project).createCachedValue(
            CachedValueProvider<MutableMap<KtElement, CachedFullResolve>> {
                Result.create(ContainerUtil.createConcurrentSoftValueMap<KtElement, CachedFullResolve>(),
    ...
    private val partialBodyResolveCache: CachedValue<MutableMap<KtExpression, CachedPartialResolve>> =
            CachedValuesManager.getManager(project).createCachedValue(
                    CachedValueProvider<MutableMap<KtExpression, CachedPartialResolve>> {
                        Result.create(ContainerUtil.createConcurrentSoftValueMap<KtExpression, CachedPartialResolve>(),
